...
import { getDefaultVaultId, generateQueryPath, addHexPrefix } from '../src/helpers/request-helpers';
...
describe('request-helpers', () => {
  ...
  describe('addHexPrefix', () => {
    it('should add 0x prefix if it does not exist', async () => {
      expect(addHexPrefix('0x06b974202431eb8c0692c9c8111528d947bc7e70f7ffefaffbab7455dfa5d4f7')).toEqual('0x06b974202431eb8c0692c9c8111528d947bc7e70f7ffefaffbab7455dfa5d4f7');
      expect(addHexPrefix('02d71a80ccf5b0add0325ac066ae47966b633cddb510987c420cebce6a8eee01')).toEqual('0x02d71a80ccf5b0add0325ac066ae47966b633cddb510987c420cebce6a8eee01');
    });
  });
});
