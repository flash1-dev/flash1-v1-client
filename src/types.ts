...
export interface NetworkUserData {
  email: string;
  balance: number;
  totalDeposit: number; // the user's lifetime deposit amount
  totalWithdrawal: number; // the user's lifetime withdrawal amount
  rolling: number; // this week's total investment volume
  tradingVolume: number; // this week's trading volume
  lifetimeRolling: number; // lifetime rolling amount
  lifetimeValue: number; // total fees generated by the user
}
